...
class CollectorsPhp74ArrowsTest extends TestCase
{
    /**
    ...
    public function testCollections()
    {
        ...
        $collector = Collector::of(Collector::TO_ASSOC_ARRAY, fn (CollectionsSampleObject $obj) => ['key' => $obj->getId(), 'value' => $obj]);
        $collected = Collections::collect($manyObjects, $collector);
