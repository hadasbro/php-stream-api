...
class _NoneMatchExamples
{
     ...
     */
    public static function noneMatch()
    {
     ...
     * @throws CollectionsException
     */
    public static function noneMatch2()
    {
        ...
        var_dump($noneMatch); // true
        var_dump($noneMatch2); // false
     ...
     * @throws CollectionsException
     */
    public static function noneMatch3()
    {
         ...
         * @var $noneMatch bool
         */
        $noneMatch = Collections::noneMatch($manyObjects, function (CollectionsSampleObject $obj1) {
     ...
     * @throws CollectionsException
     */
    public static function noneMatch4()
    {
